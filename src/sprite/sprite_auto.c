...
/*   Updated: 2023/10/11 13:56:55 by ycardona         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_sprite(t_game *game)
{
	...
	sprite_ortho.x = -sprite_dir.y * fact / sqrt(pow(-sprite_dir.y, 2) + pow(sprite_dir.x, 2));
	sprite_ortho.y = sprite_dir.x * fact / sqrt(pow(-sprite_dir.y, 2) + pow(sprite_dir.x, 2));
